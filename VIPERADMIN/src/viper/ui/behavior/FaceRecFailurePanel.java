...
public class FaceRecFailurePanel extends JPanel {
	...
	private Object[][] data = DBController.to3dArray(DBController.retrieveFaceRecFailure());
	
	/**
	 * Create the panel.
	 */
	public FaceRecFailurePanel() {
		super();
		initialize();
	}

	public FaceRecFailurePanel(JFrame f) {
		super();
		frame = f;
		initialize();
	}
	...
	class MyTableModel extends AbstractTableModel {
       ...
       Object[][] data = DBController.to3dArray(DBController.retrieveFaceRecFailure());
