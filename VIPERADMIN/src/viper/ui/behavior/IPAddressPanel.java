...
public class IPAddressPanel extends JPanel {
	...
	private Object[][] data = DBController.to3dArray(DBController.retrieveIPAddress());
	...
	public IPAddressPanel(JFrame f) {
		super();
		frame = f;
		initialize();
	}
                ...
                if (e.isPopupTrigger() && e.getComponent() instanceof JTable ) {
            		...
            		menuItem.addActionListener(new ActionListener() {
            			...
            			public void actionPerformed(ActionEvent arg0) {
            				// suspend user
            				DBController.updateSuspension(data[table.getSelectedRow()][2].toString(), true, "IP Address");
	...
	class MyTableModel extends AbstractTableModel {
       ...
       Object[][] data = DBController.to3dArray(DBController.retrieveIPAddress());
