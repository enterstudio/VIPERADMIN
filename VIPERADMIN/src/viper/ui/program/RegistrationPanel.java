...
public class RegistrationPanel extends JPanel {
	...
	public RegistrationPanel(JFrame f) {
		super();
		frame = f;
		initialize();
	}
	...
	private XYDataset createDataset() {
        ...
        XYSeries series1 = new XYSeries("Registrations");
        ArrayList<Object[]> arr = DBController.retrieveRegistrations();
        Object[] data;
    ...
    private JFreeChart createChart(final XYDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createXYLineChart(
            "Registration by Month",  // chart title
            "Month",                      // x axis label
            "Count",                      // y axis label
            dataset,                  // data
